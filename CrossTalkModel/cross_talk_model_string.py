...
CROSS_TALK_MODEL = """
    ...
    model CrossTalkModel()
        ...
        Smad2 = 29.286012999111;
        pSmad2 = 5.29630724778407;
        Mek = 10.6235437627047;
        pMek = 3.0544502452824;
        Erk = 0.0455768218929236;
        pErk = 59.7333871047308;
        PI3K = 246.510017733598;
        pPI3K = 3.75554447770751;
        Akt = 6.29368287211892;
        pAkt = 0.00773283758523463;
        mTORC1 = 235.456373446227;
        pmTORC1 = 7.63789367041111;
        S6K = 9.44945415882862;
        pS6K = 5.19623154573045;
        Raf = 0.137417899306174;
        pRaf = 1.782538149644;
        ppMek = 0.100445796018932;
        ppErk = 1.00751751755595;
        
        // Compartment initializations:
        Cell = 1;
        
        // Variable initializations:
        _kTGFbOn = 0.00251959961398397;
        TGFb = 0.005;
        kTGFbOff = 1;
        kTGFbRIntern = 0.33;
        kTGFbRRecyc = 0.033;
        kSmad2Phos_km = 50;
        _kSmad2Phos_kcat = 0.016228806691197;
        kSmad2Dephos_km = 60;
        ...
        _kPI3KPhosByGF = 101.148488926392;
        _kPI3KDephosByS6K = 53.7288161761565;
        kAktPhos_km = 12.5;
        _kAktPhos_ki = 279.185578534311;
        _kAktPhos_kcat = 81.5796026313727;
        MK2206 = 0;
        kAktDephos_km = 15;
        kAktDephos_Vmax = 30;
        kmTORC1Phos_km = 3;
        _kmTORC1Phos_ki = 0.00294801909869728;
        _kmTORC1Phos_kcat = 0.452565077656586;
        Everolimus = 1;
        _kmTORCPhosBasal_Vmax = 0.00121874073143371;
        kmTORCPhosBasal_km = 25;
        kmTORC1Dephos_km = 100;
        kmTORC1Dephos_Vmax = 1;
        kS6KPhosBymTORC1_km = 100;
        _kS6KPhosBymTORC1_kcat = 6.06204259693966;
        kS6KDephos_km = 10;
        kS6KDephos_Vmax = 50;
        kRafPhosByTGFbR_km = 25;
        _kRafPhosByTGFbR_kcat = 0.0502796204512501;
        kRafPhosByPI3K_km = 50;
        _kRafPhosByPI3K_kcat = 61.3502015418875;
        kPI3KPhosByTGFbR_km = 10;
        _kPI3KPhosByTGFbR_kcat = 0.274127213104624;
        _kPI3KDephosByErk = 91.1841998214853;
