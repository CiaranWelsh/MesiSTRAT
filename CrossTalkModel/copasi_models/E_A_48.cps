...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_42" name="NonCompetitiveInhibition" type="UserDefined" reversible="unspecified">
      <Expression>
        Vmax*S/((km+S)*(1+(I/ki)^n))
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_273" name="km" order="0" role="variable"/>
        <ParameterDescription key="FunctionParameter_274" name="ki" order="1" role="variable"/>
        <ParameterDescription key="FunctionParameter_275" name="Vmax" order="2" role="variable"/>
        <ParameterDescription key="FunctionParameter_276" name="n" order="3" role="variable"/>
        <ParameterDescription key="FunctionParameter_277" name="I" order="4" role="variable"/>
        <ParameterDescription key="FunctionParameter_278" name="S" order="5" role="variable"/>
      </ListOfParameterDescriptions>
    </Function>
    ...
    <Function key="Function_49" name="MM_1" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_309" name="kpSmad2Imp_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_319" name="kpSmad2Imp_km" order="1" role="constant"/>
    ...
    <Function key="Function_50" name="MM_2" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_324" name="kSmad2Exp_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_325" name="kSmad2Exp_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_326" name="pSmad2n" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_51" name="MM_3" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_330" name="Smad2" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_331" name="kSmad2Imp_Vmax" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_332" name="kSmad2Imp_km" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_52" name="MM_4" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_336" name="Smad2n" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_337" name="kSmad2Exp_Vmax" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_338" name="kSmad2Exp_km" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_53" name="MM_5" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_342" name="kpSmad2Dephos_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_343" name="kpSmad2Dephos_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_344" name="pSmad2n" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_54" name="Function for MAPK_R0" type="UserDefined" reversible="false">
      <Expression>
        GrowthFactors*NonCompetitiveInhibition(kRafPhos_km,kRafPhos_ki,kRafPhos_Vmax,kRafPhos_n,ppErk,Raf)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_352" name="GrowthFactors" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_353" name="Raf" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_354" name="kRafPhos_Vmax" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_355" name="kRafPhos_ki" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_356" name="kRafPhos_km" order="4" role="constant"/>
        <ParameterDescription key="FunctionParameter_357" name="kRafPhos_n" order="5" role="constant"/>
        <ParameterDescription key="FunctionParameter_358" name="ppErk" order="6" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_55" name="MM_6" type="UserDefined" reversible="false">
      <Expression>
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_348" name="kRafDephos_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_351" name="pRaf" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_56" name="CompetitiveInhibition_1" type="UserDefined" reversible="false">
      <Expression>
        kMekPhos_kcat1*pRaf*Mek/(kMekPhos_km1+Mek+kMekPhos_km1*AZD/kMekPhos_ki1)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_371" name="AZD" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_372" name="Mek" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_373" name="kMekPhos_kcat1" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_374" name="kMekPhos_ki1" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_375" name="kMekPhos_km1" order="4" role="constant"/>
        <ParameterDescription key="FunctionParameter_376" name="pRaf" order="5" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_57" name="CompetitiveInhibition_2" type="UserDefined" reversible="false">
      <Expression>
        kMekPhos_kcat1*pRaf*pMek/(kMekPhos_km1+pMek+kMekPhos_km1*AZD/kMekPhos_ki1)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_383" name="AZD" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_384" name="kMekPhos_kcat1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_385" name="kMekPhos_ki1" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_386" name="kMekPhos_km1" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_387" name="pMek" order="4" role="substrate"/>
        <ParameterDescription key="FunctionParameter_388" name="pRaf" order="5" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_58" name="MM_7" type="UserDefined" reversible="false">
      <Expression>
        kMekDephos_Vmax1*ppMek/(kMekDephos_km1+ppMek)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_369" name="kMekDephos_Vmax1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_308" name="kMekDephos_km1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_350" name="ppMek" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_59" name="MM_8" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_398" name="kMekDephos_Vmax1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_399" name="kMekDephos_km1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_400" name="pMek" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_60" name="MMWithKcat_2" type="UserDefined" reversible="false">
      <Expression>
        kErkPhos_kcat1*ppMek*Erk/(kErkPhos_km1+Erk)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_405" name="Erk" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_406" name="kErkPhos_kcat1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_407" name="kErkPhos_km1" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_408" name="ppMek" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_61" name="MMWithKcat_3" type="UserDefined" reversible="false">
      <Expression>
        kErkPhos_kcat1*ppMek*pErk/(kErkPhos_km1+pErk)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_413" name="kErkPhos_kcat1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_414" name="kErkPhos_km1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_415" name="pErk" order="2" role="substrate"/>
        <ParameterDescription key="FunctionParameter_416" name="ppMek" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_62" name="MM_9" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_368" name="kErkDephos_Vmax1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_421" name="kErkDephos_km1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_422" name="ppErk" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_63" name="MM_10" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_426" name="kErkDephos_Vmax1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_427" name="kErkDephos_km1" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_428" name="pErk" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_64" name="Function for PI3K_R1" type="UserDefined" reversible="false">
      <Expression>
        kPI3KPhosByGF*PI3K*GrowthFactors
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_432" name="GrowthFactors" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_433" name="PI3K" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_434" name="kPI3KPhosByGF" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_65" name="Function for PI3K_R2" type="UserDefined" reversible="false">
      <Expression>
        kPI3KDephosByS6K*pPI3K*pS6K
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_438" name="kPI3KDephosByS6K" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_439" name="pPI3K" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_440" name="pS6K" order="2" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_66" name="CompetitiveInhibition_3" type="UserDefined" reversible="false">
      <Expression>
        kAktPhos_kcat*pPI3K*Akt/(kAktPhos_km+Akt+kAktPhos_km*MK2206/kAktPhos_ki)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_447" name="Akt" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_448" name="MK2206" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_449" name="kAktPhos_kcat" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_450" name="kAktPhos_ki" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_451" name="kAktPhos_km" order="4" role="constant"/>
        <ParameterDescription key="FunctionParameter_452" name="pPI3K" order="5" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_67" name="MM_11" type="UserDefined" reversible="false">
      <Expression>
        kAktDephos_Vmax*pAkt/(kAktDephos_km+pAkt)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_349" name="kAktDephos_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_445" name="kAktDephos_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_370" name="pAkt" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_68" name="CompetitiveInhibition_4" type="UserDefined" reversible="false">
      <Expression>
        kmTORC1Phos_kcat*pAkt*mTORC1/(kmTORC1Phos_km+mTORC1+kmTORC1Phos_km*Everolimus/kmTORC1Phos_ki)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_465" name="Everolimus" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_466" name="kmTORC1Phos_kcat" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_467" name="kmTORC1Phos_ki" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_468" name="kmTORC1Phos_km" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_469" name="mTORC1" order="4" role="substrate"/>
        <ParameterDescription key="FunctionParameter_470" name="pAkt" order="5" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_69" name="MM_12" type="UserDefined" reversible="false">
      <Expression>
        kmTORC1Dephos_Vmax*pmTORC1/(kmTORC1Dephos_km+pmTORC1)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_464" name="kmTORC1Dephos_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_444" name="kmTORC1Dephos_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_463" name="pmTORC1" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_70" name="MMWithKcat_4" type="UserDefined" reversible="false">
      <Expression>
        kS6KPhosBymTORC1_kcat*pmTORC1*S6K/(kS6KPhosBymTORC1_km+S6K)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_481" name="S6K" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_482" name="kS6KPhosBymTORC1_kcat" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_483" name="kS6KPhosBymTORC1_km" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_484" name="pmTORC1" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_71" name="MM_13" type="UserDefined" reversible="false">
      <Expression>
        kS6KDephos_Vmax*pS6K/(kS6KDephos_km+pS6K)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_446" name="kS6KDephos_Vmax" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_489" name="kS6KDephos_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_490" name="pS6K" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_72" name="MMWithKcat_5" type="UserDefined" reversible="false">
      <Expression>
        kRafPhosByTGFbR_kcat*TGFbR_Cav*Raf/(kRafPhosByTGFbR_km+Raf)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_495" name="Raf" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_496" name="TGFbR_Cav" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_497" name="kRafPhosByTGFbR_kcat" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_498" name="kRafPhosByTGFbR_km" order="3" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_73" name="MMWithKcat_6" type="UserDefined" reversible="false">
      <Expression>
        kRafPhosByPI3K_kcat*pPI3K*Raf/(kRafPhosByPI3K_km+Raf)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_503" name="Raf" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_504" name="kRafPhosByPI3K_kcat" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_505" name="kRafPhosByPI3K_km" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_506" name="pPI3K" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_74" name="MMWithKcat_7" type="UserDefined" reversible="false">
      <Expression>
        kPI3KPhosByTGFbR_kcat*TGFbR_Cav*PI3K/(kPI3KPhosByTGFbR_km+PI3K)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_511" name="PI3K" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_512" name="TGFbR_Cav" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_513" name="kPI3KPhosByTGFbR_kcat" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_514" name="kPI3KPhosByTGFbR_km" order="3" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_75" name="Function for CrossTalkR4" type="UserDefined" reversible="false">
      <Expression>
        kPI3KDephosByErk*pPI3K*ppErk
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_494" name="kPI3KDephosByErk" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_519" name="pPI3K" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_520" name="ppErk" order="2" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_76" name="MMWithKcat_8" type="UserDefined" reversible="false">
      <Expression>
        kSmad2PhosByAkt_kcat*pAkt*Smad2/(kSmad2PhosByAkt_km+Smad2)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_525" name="Smad2" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_526" name="kSmad2PhosByAkt_kcat" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_527" name="kSmad2PhosByAkt_km" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_528" name="pAkt" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_77" name="MMWithKcat_9" type="UserDefined" reversible="false">
      <Expression>
        kSmad2DephosByErk_kcat*ppErk*pSmad2n/(kSmad2DephosByErk_km+pSmad2n)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_533" name="kSmad2DephosByErk_kcat" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_534" name="kSmad2DephosByErk_km" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_535" name="pSmad2n" order="2" role="substrate"/>
        <ParameterDescription key="FunctionParameter_536" name="ppErk" order="3" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="TGFbModule" simulationType="time" timeUnit="h" volumeUnit="l" areaUnit="m&#178;" lengthUnit="m" quantityUnit="nmol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_6" name="pSmad2n" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="26969318906664.4">
      </Metabolite>
      <Metabolite key="Metabolite_7" name="Smad2n" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="2.99762947452472e+16">
      </Metabolite>
      <Metabolite key="Metabolite_8" name="Mek" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="1.5228567762895856e+17">
      </Metabolite>
      <Metabolite key="Metabolite_9" name="pMek" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="3.3762689754202348e+16">
      </Metabolite>
      <Metabolite key="Metabolite_10" name="Erk" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="1.1040507301812789e+17">
      </Metabolite>
      <Metabolite key="Metabolite_11" name="pErk" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="7.09903494779345e+16">
      </Metabolite>
      <Metabolite key="Metabolite_12" name="PI3K" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="6.019751165508762e+16">
      </Metabolite>
      <Metabolite key="Metabolite_13" name="pPI3K" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="23906244912320.023">
      </Metabolite>
      <Metabolite key="Metabolite_14" name="Akt" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5.9868063199575336e+16">
      </Metabolite>
      <Metabolite key="Metabolite_15" name="pAkt" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="353354698618055.75">
      </Metabolite>
      <Metabolite key="Metabolite_16" name="mTORC1" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5.436335312462394e+16">
      </Metabolite>
      <Metabolite key="Metabolite_17" name="pmTORC1" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5858064775376091.0">
      </Metabolite>
      <Metabolite key="Metabolite_18" name="S6K" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5.450459027995909e+16">
      </Metabolite>
      <Metabolite key="Metabolite_19" name="pS6K" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5716827620643109.0">
      </Metabolite>
      <Metabolite key="Metabolite_20" name="Raf" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="5.2954255562812696e+16">
      </Metabolite>
      <Metabolite key="Metabolite_21" name="pRaf" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="7267162338328442.0">
      </Metabolite>
      <Metabolite key="Metabolite_22" name="ppMek" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="1.7481983859999028e+16">
      </Metabolite>
      <Metabolite key="Metabolite_23" name="ppErk" simulationType="reactions" compartment="Compartment_0" addNoise="false" particle_numbers="2.594715898704886e+16">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="kpSmad2Imp_km" simulationType="assignment" addNoise="false" initial_value="90.0">
        <Expression>
          &lt;CN=Root,Model=TGFbModule,Vector=Values[kSmad2Imp_km],Reference=Value&gt;
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_1" name="kSmad2Imp_km" simulationType="fixed" addNoise="false" initial_value="90.0">
      </ModelValue>
      <ModelValue key="ModelValue_2" name="kpSmad2Imp_Vmax" simulationType="assignment" addNoise="false" initial_value="115.398">
        <Expression>
      ...
      <ModelValue key="ModelValue_3" name="kSmad2Imp_Vmax" simulationType="fixed" addNoise="false" initial_value="38.466">
      </ModelValue>
      <ModelValue key="ModelValue_4" name="mul" simulationType="fixed" addNoise="false" initial_value="3.0">
      </ModelValue>
      <ModelValue key="ModelValue_5" name="Smad2Tot" simulationType="assignment" addNoise="false" initial_value="100.0000466">
        <Expression>
      ...
      <ModelValue key="ModelValue_6" name="pSmad2Tot" simulationType="assignment" addNoise="false" initial_value="0.5453466">
        <Expression>
      ...
      <ModelValue key="ModelValue_7" name="kTGFbOn" simulationType="fixed" addNoise="false" initial_value="0.1">
      </ModelValue>
      <ModelValue key="ModelValue_8" name="TGFb" simulationType="fixed" addNoise="false" initial_value="0.005">
      </ModelValue>
      <ModelValue key="ModelValue_9" name="kTGFbOff" simulationType="fixed" addNoise="false" initial_value="0.04">
      </ModelValue>
      <ModelValue key="ModelValue_10" name="kTGFbRIntern" simulationType="fixed" addNoise="false" initial_value="0.3333333333">
      </ModelValue>
      <ModelValue key="ModelValue_11" name="kTGFbRRecyc" simulationType="fixed" addNoise="false" initial_value="0.03333333333">
      </ModelValue>
      <ModelValue key="ModelValue_12" name="kSmad2Phos_km" simulationType="fixed" addNoise="false" initial_value="50.0">
      </ModelValue>
      <ModelValue key="ModelValue_13" name="kSmad2Phos_kcat" simulationType="fixed" addNoise="false" initial_value="0.1">
      </ModelValue>
      <ModelValue key="ModelValue_14" name="kSmad2Exp_km" simulationType="fixed" addNoise="false" initial_value="20.0">
      </ModelValue>
      <ModelValue key="ModelValue_15" name="kSmad2Exp_Vmax" simulationType="fixed" addNoise="false" initial_value="20.0">
      </ModelValue>
      <ModelValue key="ModelValue_16" name="kpSmad2Dephos_km" simulationType="fixed" addNoise="false" initial_value="60.0">
      </ModelValue>
      <ModelValue key="ModelValue_17" name="kpSmad2Dephos_Vmax" simulationType="fixed" addNoise="false" initial_value="65.0">
      </ModelValue>
      <ModelValue key="ModelValue_18" name="GrowthFactors" simulationType="fixed" addNoise="false" initial_value="1.0">
      </ModelValue>
      <ModelValue key="ModelValue_19" name="kRafPhos_km" simulationType="fixed" addNoise="false" initial_value="10.0">
      </ModelValue>
      <ModelValue key="ModelValue_20" name="kRafPhos_ki" simulationType="fixed" addNoise="false" initial_value="3.5">
      </ModelValue>
      <ModelValue key="ModelValue_21" name="kRafPhos_Vmax" simulationType="fixed" addNoise="false" initial_value="9000.0">
      </ModelValue>
      <ModelValue key="ModelValue_22" name="kRafPhos_n" simulationType="fixed" addNoise="false" initial_value="1.0">
      </ModelValue>
      <ModelValue key="ModelValue_23" name="kRafDephos_km" simulationType="fixed" addNoise="false" initial_value="8.0">
      </ModelValue>
      <ModelValue key="ModelValue_24" name="kRafDephosVmax" simulationType="fixed" addNoise="false" initial_value="3602.5">
      </ModelValue>
      <ModelValue key="ModelValue_25" name="kMekPhos_km1" simulationType="fixed" addNoise="false" initial_value="15.0">
      </ModelValue>
      <ModelValue key="ModelValue_26" name="kMekPhos_ki1" simulationType="fixed" addNoise="false" initial_value="0.25">
      </ModelValue>
      <ModelValue key="ModelValue_27" name="kMekPhos_kcat1" simulationType="fixed" addNoise="false" initial_value="90.0">
      </ModelValue>
      <ModelValue key="ModelValue_28" name="AZD" simulationType="fixed" addNoise="false" initial_value="0.0">
      </ModelValue>
      <ModelValue key="ModelValue_29" name="kMekDephos_km1" simulationType="fixed" addNoise="false" initial_value="15.0">
      </ModelValue>
      <ModelValue key="ModelValue_30" name="kMekDephos_Vmax1" simulationType="fixed" addNoise="false" initial_value="2700.0">
      </ModelValue>
      <ModelValue key="ModelValue_31" name="kErkPhos_km1" simulationType="fixed" addNoise="false" initial_value="50.0">
      </ModelValue>
      <ModelValue key="ModelValue_32" name="kErkPhos_kcat1" simulationType="fixed" addNoise="false" initial_value="200.0">
      </ModelValue>
      <ModelValue key="ModelValue_33" name="kErkDephos_km1" simulationType="fixed" addNoise="false" initial_value="15.0">
      </ModelValue>
      <ModelValue key="ModelValue_34" name="kErkDephos_Vmax1" simulationType="fixed" addNoise="false" initial_value="1800.0">
      </ModelValue>
      <ModelValue key="ModelValue_35" name="kPI3KPhosByGF" simulationType="fixed" addNoise="false" initial_value="0.239474698704283">
      </ModelValue>
      <ModelValue key="ModelValue_36" name="kPI3KDephosByS6K" simulationType="fixed" addNoise="false" initial_value="25.0">
      </ModelValue>
      <ModelValue key="ModelValue_37" name="kAktPhos_km" simulationType="fixed" addNoise="false" initial_value="12.5">
      </ModelValue>
      <ModelValue key="ModelValue_38" name="kAktPhos_ki" simulationType="fixed" addNoise="false" initial_value="0.01">
      </ModelValue>
      <ModelValue key="ModelValue_39" name="kAktPhos_kcat" simulationType="fixed" addNoise="false" initial_value="1.5">
      </ModelValue>
      <ModelValue key="ModelValue_40" name="MK2206" simulationType="fixed" addNoise="false" initial_value="0.0">
      </ModelValue>
      <ModelValue key="ModelValue_41" name="kAktDephos_km" simulationType="fixed" addNoise="false" initial_value="15.0">
      </ModelValue>
      <ModelValue key="ModelValue_42" name="kAktDephos_Vmax" simulationType="fixed" addNoise="false" initial_value="30.0">
      </ModelValue>
      <ModelValue key="ModelValue_43" name="kmTORC1Phos_km" simulationType="fixed" addNoise="false" initial_value="3.0">
      </ModelValue>
      <ModelValue key="ModelValue_44" name="kmTORC1Phos_ki" simulationType="fixed" addNoise="false" initial_value="0.001">
      </ModelValue>
      <ModelValue key="ModelValue_45" name="kmTORC1Phos_kcat" simulationType="fixed" addNoise="false" initial_value="0.35">
      </ModelValue>
      <ModelValue key="ModelValue_46" name="Everolimus" simulationType="fixed" addNoise="false" initial_value="1.0">
      </ModelValue>
      <ModelValue key="ModelValue_47" name="kmTORC1Dephos_km" simulationType="fixed" addNoise="false" initial_value="100.0">
      </ModelValue>
      <ModelValue key="ModelValue_48" name="kmTORC1Dephos_Vmax" simulationType="fixed" addNoise="false" initial_value="1.0">
      </ModelValue>
      <ModelValue key="ModelValue_49" name="kS6KPhosBymTORC1_km" simulationType="fixed" addNoise="false" initial_value="100.0">
      </ModelValue>
      <ModelValue key="ModelValue_50" name="kS6KPhosBymTORC1_kcat" simulationType="fixed" addNoise="false" initial_value="0.5">
      </ModelValue>
      <ModelValue key="ModelValue_51" name="kS6KDephos_km" simulationType="fixed" addNoise="false" initial_value="10.0">
      </ModelValue>
      <ModelValue key="ModelValue_52" name="kS6KDephos_Vmax" simulationType="fixed" addNoise="false" initial_value="50.0">
      </ModelValue>
      <ModelValue key="ModelValue_53" name="kRafPhosByTGFbR_km" simulationType="fixed" addNoise="false" initial_value="25.0">
      </ModelValue>
      <ModelValue key="ModelValue_54" name="kRafPhosByTGFbR_kcat" simulationType="fixed" addNoise="false" initial_value="265.0">
      </ModelValue>
      <ModelValue key="ModelValue_55" name="kRafPhosByPI3K_km" simulationType="fixed" addNoise="false" initial_value="50.0">
      </ModelValue>
      <ModelValue key="ModelValue_56" name="kRafPhosByPI3K_kcat" simulationType="fixed" addNoise="false" initial_value="5.0">
      </ModelValue>
      <ModelValue key="ModelValue_57" name="kPI3KPhosByTGFbR_km" simulationType="fixed" addNoise="false" initial_value="10.0">
      </ModelValue>
      <ModelValue key="ModelValue_58" name="kPI3KPhosByTGFbR_kcat" simulationType="fixed" addNoise="false" initial_value="50.0">
      </ModelValue>
      <ModelValue key="ModelValue_59" name="kPI3KDephosByErk" simulationType="fixed" addNoise="false" initial_value="0.5">
      </ModelValue>
      <ModelValue key="ModelValue_60" name="kSmad2PhosByAkt_km" simulationType="fixed" addNoise="false" initial_value="40.0">
      </ModelValue>
      <ModelValue key="ModelValue_61" name="kSmad2PhosByAkt_kcat" simulationType="fixed" addNoise="false" initial_value="0.1">
      </ModelValue>
      <ModelValue key="ModelValue_62" name="kSmad2DephosByErk_km" simulationType="fixed" addNoise="false" initial_value="30.0">
      </ModelValue>
      <ModelValue key="ModelValue_63" name="kSmad2DephosByErk_kcat" simulationType="fixed" addNoise="false" initial_value="7.5">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="TGF_R1" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4995" name="TGFb" value="0.005"/>
          <Constant key="Parameter_4994" name="kTGFbOn" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="TGF_R2" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4993" name="k1" value="0.04"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="TGF_R3" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4992" name="k1" value="0.333333"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=TGFbModule,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_3" name="TGF_R4" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4991" name="k1" value="0.0333333"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=TGFbModule,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_4" name="TGF_R5" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4990" name="k1" value="0.333333"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=TGFbModule,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_5" name="TGF_R6" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4989" name="k1" value="0.0333333"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=TGFbModule,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_6" name="TGF_R8" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4988" name="kSmad2Phos_kcat" value="0.1"/>
          <Constant key="Parameter_4987" name="kSmad2Phos_km" value="50"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_7" name="TGF_R10" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4986" name="kpSmad2Imp_Vmax" value="115.398"/>
          <Constant key="Parameter_4985" name="kpSmad2Imp_km" value="90"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_8" name="TGF_R11" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4984" name="kSmad2Exp_Vmax" value="20"/>
          <Constant key="Parameter_4983" name="kSmad2Exp_km" value="20"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_9" name="TGF_R12" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4982" name="kSmad2Imp_Vmax" value="38.466"/>
          <Constant key="Parameter_4981" name="kSmad2Imp_km" value="90"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_10" name="TGF_R13" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4980" name="kSmad2Exp_Vmax" value="20"/>
          <Constant key="Parameter_4979" name="kSmad2Exp_km" value="20"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_11" name="TGF_R14" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4978" name="kpSmad2Dephos_Vmax" value="65"/>
          <Constant key="Parameter_4977" name="kpSmad2Dephos_km" value="60"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_12" name="MAPK_R0" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4976" name="GrowthFactors" value="1"/>
          <Constant key="Parameter_4975" name="kRafPhos_Vmax" value="9000"/>
          <Constant key="Parameter_4974" name="kRafPhos_ki" value="3.5"/>
          <Constant key="Parameter_4973" name="kRafPhos_km" value="10"/>
          <Constant key="Parameter_4972" name="kRafPhos_n" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_13" name="MAPK_R1" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4971" name="kRafDephosVmax" value="3602.5"/>
          <Constant key="Parameter_4970" name="kRafDephos_km" value="8"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_14" name="MAPK_R2" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4969" name="AZD" value="0"/>
          <Constant key="Parameter_4968" name="kMekPhos_kcat1" value="90"/>
          <Constant key="Parameter_4967" name="kMekPhos_ki1" value="0.25"/>
          <Constant key="Parameter_4966" name="kMekPhos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_15" name="MAPK_R3" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4965" name="AZD" value="0"/>
          <Constant key="Parameter_4964" name="kMekPhos_kcat1" value="90"/>
          <Constant key="Parameter_4963" name="kMekPhos_ki1" value="0.25"/>
          <Constant key="Parameter_4962" name="kMekPhos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_16" name="MAPK_R4" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4961" name="kMekDephos_Vmax1" value="2700"/>
          <Constant key="Parameter_4960" name="kMekDephos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_17" name="MAPK_R5" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4959" name="kMekDephos_Vmax1" value="2700"/>
          <Constant key="Parameter_4958" name="kMekDephos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_18" name="MAPK_R6" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4957" name="kErkPhos_kcat1" value="200"/>
          <Constant key="Parameter_4956" name="kErkPhos_km1" value="50"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_19" name="MAPK_R7" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4955" name="kErkPhos_kcat1" value="200"/>
          <Constant key="Parameter_4954" name="kErkPhos_km1" value="50"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_20" name="MAPK_R8" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4953" name="kErkDephos_Vmax1" value="1800"/>
          <Constant key="Parameter_4952" name="kErkDephos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_21" name="MAPK_R9" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4951" name="kErkDephos_Vmax1" value="1800"/>
          <Constant key="Parameter_4950" name="kErkDephos_km1" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_22" name="PI3K_R1" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4949" name="GrowthFactors" value="1"/>
          <Constant key="Parameter_4948" name="kPI3KPhosByGF" value="0.239475"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_23" name="PI3K_R2" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4947" name="kPI3KDephosByS6K" value="25"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_24" name="PI3K_R3" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4946" name="MK2206" value="0"/>
          <Constant key="Parameter_4945" name="kAktPhos_kcat" value="1.5"/>
          <Constant key="Parameter_4944" name="kAktPhos_ki" value="0.01"/>
          <Constant key="Parameter_4943" name="kAktPhos_km" value="12.5"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_25" name="PI3K_R4" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4942" name="kAktDephos_Vmax" value="30"/>
          <Constant key="Parameter_4941" name="kAktDephos_km" value="15"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_26" name="PI3K_R5_1" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4940" name="Everolimus" value="1"/>
          <Constant key="Parameter_4939" name="kmTORC1Phos_kcat" value="0.35"/>
          <Constant key="Parameter_4938" name="kmTORC1Phos_ki" value="0.001"/>
          <Constant key="Parameter_4937" name="kmTORC1Phos_km" value="3"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_27" name="PI3K_R6" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4936" name="kmTORC1Dephos_Vmax" value="1"/>
          <Constant key="Parameter_4935" name="kmTORC1Dephos_km" value="100"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_28" name="PI3K_R7" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4934" name="kS6KPhosBymTORC1_kcat" value="0.5"/>
          <Constant key="Parameter_4933" name="kS6KPhosBymTORC1_km" value="100"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_29" name="PI3K_R8" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4932" name="kS6KDephos_Vmax" value="50"/>
          <Constant key="Parameter_4931" name="kS6KDephos_km" value="10"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_30" name="CrossTalkR1" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4930" name="kRafPhosByTGFbR_kcat" value="265"/>
          <Constant key="Parameter_4929" name="kRafPhosByTGFbR_km" value="25"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_31" name="CrossTalkR2" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4928" name="kRafPhosByPI3K_kcat" value="5"/>
          <Constant key="Parameter_4927" name="kRafPhosByPI3K_km" value="50"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_32" name="CrossTalkR3" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4926" name="kPI3KPhosByTGFbR_kcat" value="50"/>
          <Constant key="Parameter_4925" name="kPI3KPhosByTGFbR_km" value="10"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_33" name="CrossTalkR4" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4924" name="kPI3KDephosByErk" value="0.5"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_34" name="CrossTalkR5" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4923" name="kSmad2PhosByAkt_kcat" value="0.1"/>
          <Constant key="Parameter_4922" name="kSmad2PhosByAkt_km" value="40"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_35" name="CrossTalkR6" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4921" name="kSmad2DephosByErk_kcat" value="7.5"/>
          <Constant key="Parameter_4920" name="kSmad2DephosByErk_km" value="30"/>
        </ListOfConstants>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Values[kpSmad2Imp_Vmax]" value="115.398" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Values[mul]" value="3" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Values[kSmad2Exp_Vmax]" value="20" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Values[kpSmad2Dephos_km]" value="60" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Values[kpSmad2Dephos_Vmax]" value="65" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R10]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R10],ParameterGroup=Parameters,Parameter=kpSmad2Imp_Vmax" value="115.398" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R11]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R11],ParameterGroup=Parameters,Parameter=kSmad2Exp_Vmax" value="20" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R13]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R13],ParameterGroup=Parameters,Parameter=kSmad2Exp_Vmax" value="20" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=TGFbModule,Vector=Values[kSmad2Exp_Vmax],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R14]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R14],ParameterGroup=Parameters,Parameter=kpSmad2Dephos_Vmax" value="65" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=TGFbModule,Vector=Values[kpSmad2Dephos_Vmax],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=TGFbModule,Vector=Reactions[TGF_R14],ParameterGroup=Parameters,Parameter=kpSmad2Dephos_km" value="60" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_100" name="Time-Course" scheduled="true" type="timeCourse" update_model="false">
      <Report append="0" confirmOverwrite="0" reference="Report_30" target="/home/ncw135/Documents/MesiSTRAT/CrossTalkModel/copasi_models/TimeCourseData.txt"/>
      <Problem>
  ...
  <SBMLReference file="E_A_48.sbml">
    ...
    <SBMLMap SBMLid="NonCompetitiveInhibition" COPASIkey="Function_42"/>
